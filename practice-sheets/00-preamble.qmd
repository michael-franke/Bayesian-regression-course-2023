# Preparing: packages & global options

Here is code to install the packages necessary for the course.
...
We may also want to set the following options for later use.
